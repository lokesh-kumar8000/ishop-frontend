...
export default function ProductEdit({ category, brand, color, id }) {
  ...
  async function getProductData() {
    const getpro = await getProducts(id);
    setProductData(getpro.data);
  }
        ...
        <div className=" grid grid-cols-3 gap-4 ">
          ...
          <div>
            ...
            <input
              ...
              ref={finalRef}
              readOnly
              defaultValue={productData.finalPrice}
